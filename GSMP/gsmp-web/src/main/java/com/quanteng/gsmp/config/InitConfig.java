...
import com.quanteng.gsmp.commom.core.exception.GsmpException;
...
public class InitConfig {
    ...
    /*实体类包路径*/
    private static final String MODEL_PACKAGE_PATH = "com.quanteng.gsmp.reporsity.entity";
    ...
    public SqlSessionFactory sqlSessionFactory ()
    {
        ...
        catch (Exception e)
        {
            ...
            throw new GsmpException("999999", "init database failed.");
        }
    }
